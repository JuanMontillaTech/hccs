...
export default {
  ...
  mounted() {
    ...
    this.totalRows = this.Numerolist.length;
  },
  methods: {
    GetDate(date) {
      ...
      this.$axios
        ...
        .then((response) => {
          ...
          data.map((schema) => {
            ...
            this.Numerolist.push(objSchema);
          });
        })
        .catch((error) => {
      ...
      <div class="col-md-4">
        <div>
          <button type="button" class="btn btn-success mb-3">
            <i class="mdi mdi-plus me-1"></i> Agregar Numero
          </button>
        </div>
      </div>
