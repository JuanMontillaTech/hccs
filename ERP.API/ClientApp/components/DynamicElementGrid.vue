      ...
      <template v-if="item.showForm == 1">
        ...
        <div  class="col-4">
          ...
          <template v-if="item.isRequired" >
            ...
            <validation-provider rules="required" v-slot="{ errors }">
              ...
              <input v-model="Scheme[item.field]" name="Scheme[item.field]"  type="text"   autocomplete="off" class="form-control" />
        ...
        <b-form-group v-if="item.type == 8">
          ...
          <template v-if="item.isRequired">
            <h4 class="card-title" v-if="labelShow">{{ item.label }}</h4>
            <validation-provider rules="required" v-slot="{ errors }">
              <ckeditor v-model="Scheme[item.field]" :editor="editor" ></ckeditor>
