                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <b-form-group>
                                    <h3 class="card-title" v-if="DataForm.isClient">Cliente</h3>


                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Teléfono">
                                                <b-form-input v-model="Contact.phone1" size="sm" trim>
                                                </b-form-input>
                                            </b-form-group>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Número Documento">
                                                <b-form-input v-model="Contact.documentNumber" size="sm" trim
                                                    :disabled="ContactaValidate">
                                                </b-form-input>
                                            </b-form-group>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Nombre/Razón social">
                                                <b-form-input v-model="Contact.name" size="sm" trim
                                                    :disabled="ContactaValidate">
                                                </b-form-input>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <b-form-group label="Dirección">
                                                <b-form-input v-model="Contact.address" size="sm" trim
                                                    :disabled="ContactaValidate">
                                                </b-form-input>
                                            </b-form-group>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Correo electrónico">
                                                <b-form-input v-model="Contact.email" size="sm" trim
                                                    :disabled="ContactaValidate">
                                                </b-form-input>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Celular">
                                                <b-form-input v-model="Contact.cellPhone" size="sm" trim
                                                    :disabled="ContactaValidate">
                                                </b-form-input>
                                            </b-form-group>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Fecha">
                                                <b-form-datepicker v-model="principalSchema.date" locale="es"
                                                    :disabled="$route.query.Action == 'show'" class="mb-2">
                                                </b-form-datepicker>
                                                <p class="text-danger text-size-required m-0"
                                                    v-if="$v.principalSchema.date.$error">
                                                    Campo requerido.
                                                </p>
                                            </b-form-group>
                                        </div>
                                        <div class="col-sm-12 col-md-6" v-if="DataForm.transactionsType == 3">
                                            <b-form-group label="Metodo de Pago">
                                                <b-form-select v-model="principalSchema.paymentMethodId"
                                                    :options="paymentOptions" :disabled="$route.query.Action == 'show'">
                                                </b-form-select>
                                                <p class="text-danger text-size-required m-0"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <b-form-group label="Moneda">
                                                <vueselect :options="Currency" placeholder="Seleccione la moneda"
                                                    :reduce="(row) => row.id" label="name" size="sm">
                        ...
                        <div class="row ml-0 mb-3">
                            <div class="col-lg-3">
                                <b-form-group>
                                    ...
                                    <b-form-input v-model="invoice_subtotal" :disabled="ContactaValidate">
                                    </b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-lg-3">
                                <b-form-group>
                                    ...
                                    <b-form-input v-model="invoice_total" :disabled="ContactaValidate"></b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-lg-3">
                                <b-form-group>
                                    <h4 class="card-title">Impuesto %</h4>
                                    <b-form-input v-model="invoice_tax" :disabled="ContactaValidate"></b-form-input>
                                </b-form-group>
                            </div>
                        </div>
...
export default {
    ...
    watch: {
        'Contact.phone1'() {
            ...
            if (this.Contact.phone1.length >= 5) {
                this.getContactByPhone();
            } else {
                this.ContactaValidate = false;
                this.clearForm();
            }
        }
    },
    methods: {
        ...
        GetFormRows() {
            ...
            this.DataForm = [];
            this.$axios.get(`Form/GetById/${this.$route.query.Form}`).then((response) => { this.DataForm = response.data.data; })
                .catch((error) => {
        ...
        async getContactByPhone() {
            let url = `Contact/GetContactByPhone?Phone=${this.Contact.phone1}`;
            let result = null;
            this.$axios
                .get(url)
                .then((response) => {
